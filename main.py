...
class SecretRevealerGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Secret‑Revealer v2.3 – Full OSINT Engine")
    ...
    def _build_main_layout(self):
        ...
        ttk.Checkbutton(left_frame, text="Enrichment (Breaches, WHOIS)", variable=self.enrich_var).grid(row=8, column=0, columnspan=2, sticky=tk.W)
